...
declare namespace Matter {
    ...
    */
    ...
    export type Bound = {min: Position, max: Position}

    export type ObjectProp = Position | Bound | {position: number}
    ...
    */
    export class Render {
         ...
         */
        static lookAt(render: Render, objects: ObjectProp[] | ObjectProp, padding?, center?): void;
